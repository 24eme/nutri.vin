...
class QRMarkupSVGLogo extends QRMarkupSVG
{
    ...
    */
    ...
    return sprintf(
        '%4$s<text x="50%%" y="%3$s" font-size="2.4" font-kerning="normal" font-stretch="200%%" font-family="Liberation Mono, Verdana, Arial, Helvetica, sans-serif" text-anchor="middle">E (100ml) = %1$s KCal / %2$s KJ</text>%4$s',
