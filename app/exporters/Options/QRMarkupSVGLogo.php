...
class QRMarkupSVGLogo extends QRMarkupSVG
{
    ...
    */
    ...
    {
        return sprintf(
            '%2$s<text x="50%%" y="3" font-size="2" font-kerning="normal" font-family="Noto Sans Mono, Liberation Mono, Verdana, Arial, Helvetica, sans-serif" text-anchor="middle">%1$s</text>%2$s',
    ...
    return sprintf(
        '%4$s<text x="50%%" y="%3$s" font-size="2" font-kerning="normal" font-family="Noto Sans Mono, Liberation Mono, Verdana, Arial, Helvetica, sans-serif" text-anchor="middle">E (100 ml) = %1$s KCal / %2$s KJ</text>%4$s',
