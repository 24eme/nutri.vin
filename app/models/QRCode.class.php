...
class QRCode extends Mapper
{
  ...
  public static function getFullListeIngredients() {
        return [
            ...
            _("Gélatine alimentaire") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Protéine de blé") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Protéine issue de pois") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Protéine issue de pommes de terre") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Colle de poisson") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Caséines") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Caséinates de potassium") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Ovalbumine") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Bentonite - E558") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Dioxyde de silicium - E551") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Kaolin") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Tanins") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Chitosane dérivé d'Aspergillus niger") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Chitine-glucane dérivé d'Aspergillus") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Polyvinylpolypyrrolidone - E1202") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Alginate de calcium - E404") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
            _("Alginate de potassium - E402") => ["additif" => "Activateur de fermentation", 'facultatif' => true],
  ...
  private function saveVersion() {
	...
	public function getQRCodeContent($format, $urlbase, $config) {
        return Exporter::getInstance()->getQRCodeContent(
            $urlbase.'/'.$this->getId(),
            $format,
            ($this->logo) ? $config['qrcode_logo'] : false,
